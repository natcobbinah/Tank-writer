...
public class VirtualKeyboardPanel extends JPanel {
	...
	public VirtualKeyboardPanel() {
		...
		try {
			keyBundle = ResourceBundle.getBundle("VirtualKeyboard.Keyboard", localeL);
	...
	public final void updateGUI() {
		...
		case 0:
			...
			// jBR4B13.setText(keyBundle.getString(KeyEnums.jBR4B13.toString())); //Shift
			// Key
			// ROW5*********************************************************************
			// jBCtrl.setText(keyBundle.getString(KeyEnums.jBCTRL.toString())); //Ctrl Key
			// jBSpace.setText(keyBundle.getString(KeyEnums.jBSPACE.toString())); //Space
			// Key
		...
		case 1:
			...
			// ROW4*********************************************************************
			// jBR4B1.setText(keyBundle.getString(KeyEnums.jBR4B1_0.toString())); //Shift
			// Key
			...
			// jBR4B13.setText(keyBundle.getString(KeyEnums.jBR4B13_0.toString())); //Shift
			// Key
			// ROW5*********************************************************************
			// jBCtrl.setText(keyBundle.getString(KeyEnums.jBCTRL_0.toString())); //Ctrl Key
			// jBSpace.setText(keyBundle.getString(KeyEnums.jBSPACE_0.toString())); //Space
			// Key
		...
		case 2:
			...
			// ROW4*********************************************************************
			// jBR4B1.setText(keyBundle.getString(KeyEnums.jBR4B1_1.toString())); //Shift
			// Key
			...
			// jBR4B13.setText(keyBundle.getString(KeyEnums.jBR4B13_1.toString())); //Shift
			// Key
			// ROW5*********************************************************************
			// jBCtrl.setText(keyBundle.getString(KeyEnums.jBCTRL_1.toString())); //Ctrl Key
			// jBSpace.setText(keyBundle.getString(KeyEnums.jBSPACE_1.toString())); //Space
			// Key
	...
	public void setLocaleL(Locale localeL) {
		...
		try {
			keyBundle = ResourceBundle.getBundle("VirtualKeyboard.Keyboard", this.localeL);
		} catch (MissingResourceException e) {
			System.err.println(e);
		}
		updateGUI();
	...
	// -------------------------------------------------------------------------
	public void setTextComponent(JTextComponent textComponent,JTabbedPane tpane) {
		this.textComponent = textComponent;
		this.tpane=tpane;
	}
	...
	private void writeValue(java.awt.event.ActionEvent evt) {
		...
		text = new StringBuffer(text).insert(index, ((JButton) evt.getSource()).getText()).toString();
	...
	private void initComponents() {
		...
		jBR4B11 = new JButton();
		jBR4B12 = new JButton();
		jTBR4B13 = new JToggleButton();
		jBCtrl = new JButton();
		jBSpace = new JButton();
		jTBAlt_Gr = new JToggleButton();
		jBExe = new JButton();
		...
		jBBackspace.setIcon(Utils.createIcon("/images/backspace.gif"));
		...
		jBR2B1.setIcon(Utils.createIcon("/images/tab.gif"));
		...
		jBEnter.setIcon(Utils.createIcon("/images/enter.gif"));
		...
		jTBR3B1.setIcon(Utils.createIcon("/images/shiftInvert.gif"));
		...
		jTBR4B1.setIcon(Utils.createIcon("/images/shift.gif"));
		...
		jTBR4B13.setIcon(Utils.createIcon("/images/shift.gif"));
		...
		jBSpace.setIcon(Utils.createIcon("/images/space.gif"));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup().addGap(22, 22, 22).addComponent(jBR2B5)
										.addGap(5, 5, 5).addComponent(jBR2B6).addGap(5, 5, 5).addComponent(jBR2B7)
										.addGap(5, 5, 5).addComponent(jBR2B8).addGap(5, 5, 5).addComponent(jBR2B9)
										.addGap(5, 5, 5).addComponent(jBR2B10).addGap(5, 5, 5).addComponent(jBR2B11)
										.addGap(5, 5, 5).addComponent(jBR2B12).addGap(5, 5, 5).addComponent(jBR2B13))
								.addGroup(layout.createSequentialGroup().addGap(21, 21, 21).addComponent(jBEnter)
										.addGap(5, 5, 5).addComponent(jTBR3B1).addGap(5, 5, 5).addComponent(jBR3B2)
										.addGap(5, 5, 5).addComponent(jBR3B3).addGap(5, 5, 5).addComponent(jBR3B4)
										.addGap(5, 5, 5).addComponent(jBR3B5).addGap(5, 5, 5).addComponent(jBR3B6)
										.addGap(5, 5, 5).addComponent(jBR3B7))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR3B8)
										.addGap(5, 5, 5).addComponent(jBR3B9).addGap(5, 5, 5).addComponent(jBR3B10)
										.addGap(5, 5, 5).addComponent(jBR3B11).addGap(5, 5, 5).addComponent(jBR3B12)
										.addGap(5, 5, 5).addComponent(jBR3B13).addGap(5, 5, 5).addComponent(jTBR4B1)
										.addGap(5, 5, 5).addComponent(jBR4B2).addGap(5, 5, 5).addComponent(jBR4B3))
								.addGroup(layout.createSequentialGroup().addGap(22, 22, 22).addComponent(jBR4B4)
										.addGap(5, 5, 5).addComponent(jBR4B5).addGap(5, 5, 5).addComponent(jBR4B6)
										.addGap(5, 5, 5).addComponent(jBR4B7).addGap(5, 5, 5).addComponent(jBR4B8)
										.addGap(5, 5, 5).addComponent(jBR4B9).addGap(5, 5, 5).addComponent(jBR4B10)
										.addGap(5, 5, 5).addComponent(jBR4B11).addGap(5, 5, 5).addComponent(jBR4B12))
								.addGroup(layout.createSequentialGroup().addGroup(layout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(layout.createSequentialGroup().addGap(3, 3, 3).addComponent(jBR1B1)
												.addGap(5, 5, 5).addComponent(jBR1B2).addGap(5, 5, 5)
												.addComponent(jBR1B3).addGap(5, 5, 5).addComponent(jBR1B4)
												.addGap(5, 5, 5).addComponent(jBR1B5).addGap(5, 5, 5)
												.addComponent(jBR1B6).addGap(5, 5, 5).addComponent(jBR1B7)
												.addGap(5, 5, 5).addComponent(jBR1B8).addGap(5, 5, 5)
												.addComponent(jBR1B9).addGap(5, 5, 5).addComponent(jBR1B10))
										.addGroup(layout.createSequentialGroup().addGap(20, 20, 20)
												.addComponent(jBR1B11).addGap(5, 5, 5).addComponent(jBR1B12)
												.addGap(5, 5, 5).addComponent(jBR1B13).addGap(5, 5, 5)
												.addComponent(jBBackspace).addGap(5, 5, 5).addComponent(jBR2B1)
												.addGap(5, 5, 5).addComponent(jBR2B2).addGap(5, 5, 5)
												.addComponent(jBR2B3).addGap(5, 5, 5).addComponent(jBR2B4))
										.addGroup(layout.createSequentialGroup().addGap(102, 102, 102)
												.addComponent(jTBR4B13).addGap(5, 5, 5).addComponent(jBCtrl)
												.addGap(5, 5, 5).addComponent(jBSpace).addGap(5, 5, 5)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(5, 5, 5)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jBR1B1).addComponent(jBR1B2).addComponent(jBR1B3).addComponent(jBR1B4)
								.addComponent(jBR1B5).addComponent(jBR1B6).addComponent(jBR1B7).addComponent(jBR1B8)
								.addComponent(jBR1B9).addComponent(jBR1B10))
						.addGap(5, 5, 5)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR1B11))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR1B12))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR1B13))
								.addComponent(jBBackspace).addComponent(jBR2B1)
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR2B2))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR2B3))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR2B4)))
						.addGap(16, 16, 16)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jBR2B5).addComponent(jBR2B6).addComponent(jBR2B7).addComponent(jBR2B8)
								.addComponent(jBR2B9).addComponent(jBR2B10).addComponent(jBR2B11).addComponent(jBR2B12)
								.addComponent(jBR2B13))
						.addGap(5, 5, 5)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jBEnter)
								.addGroup(layout.createSequentialGroup().addGap(1, 1, 1).addComponent(jTBR3B1))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR3B2))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR3B3))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR3B4))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR3B5))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR3B6))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBR3B7)))
						.addGap(5, 5, 5)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup().addGap(11, 11, 11).addComponent(jBR3B8))
								.addGroup(layout.createSequentialGroup().addGap(11, 11, 11).addComponent(jBR3B9))
								.addGroup(layout.createSequentialGroup().addGap(11, 11, 11).addComponent(jBR3B10))
								.addGroup(layout.createSequentialGroup().addGap(11, 11, 11).addComponent(jBR3B11))
								.addGroup(layout.createSequentialGroup().addGap(11, 11, 11).addComponent(jBR3B12))
								.addGroup(layout.createSequentialGroup().addGap(11, 11, 11).addComponent(jBR3B13))
								.addComponent(jTBR4B1)
								.addGroup(layout.createSequentialGroup().addGap(11, 11, 11).addComponent(jBR4B2))
								.addGroup(layout.createSequentialGroup().addGap(11, 11, 11).addComponent(jBR4B3)))
						.addGap(5, 5, 5)
						.addGroup(layout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jBR4B4)
								.addComponent(jBR4B5).addComponent(jBR4B6).addComponent(jBR4B7).addComponent(jBR4B8)
								.addComponent(jBR4B9).addComponent(jBR4B10).addComponent(jBR4B11).addComponent(jBR4B12))
						.addGap(5, 5, 5)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup().addGap(1, 1, 1).addComponent(jTBR4B13))
								.addGroup(layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jBCtrl))
								.addComponent(jBSpace)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addComponent(jBExe).addComponent(jTBAlt_Gr)))
