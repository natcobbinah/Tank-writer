...
public class Tokenizer {
	 ...
	 * 
	 * @param s2
	 *            string containing words to tokenize
	...
	/**
	 * utility to tokenize an input string into an Array of Strings - with a maximum
	 * # of returned words
	 * 
	 * @param s2
	 *            string containing words to tokenize
